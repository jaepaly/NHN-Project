 ...
 *
 * 기존 buff 효과는 마나 회복 스텁이라 "이동속도 빠르게"·"무적" 같은 표현이
...
const HASTE_RE = /빠르|신속|가속|질주|재빠|속도|경신|돌진|대시|짓쳐|들이받|박치기|쇄도|haste|swift|speed|hast|dash|charge|rush|lunge/i;
 ...
 * 이동 계약은 제거되었으므로 "돌진" 같은 속도 표현도 변위 없이 haste로 해석한다.
 */
