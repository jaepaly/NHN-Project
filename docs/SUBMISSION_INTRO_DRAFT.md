...
> **상태: 초안 v3 (2026-08-03 갱신, 총괄).** 문서·빌드·QA를 먼저 확정하고 영상은 마지막에 촬영한다.
> 갱신분: 최신 시퀀스·필살 영창 계약 반영 · 제출 범위와 스크린샷 체크리스트 정리.
> 변환 전 체크: □ 최신 프로덕션 빌드 확인 □ 스크린샷 7장 □ 데모 URL 접속 확인 □ 조작표 최신화 □ 시퀀스·필살영창 재현 확인 □ 페이지 수 ≤ 6
