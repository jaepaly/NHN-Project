...
> **현재 배포 버전 = `meaning-v2.14-slash-move`** (worker `04042e29`). 계보: v2.12→v2.13-absdir(#187 방향)→v2.14(#191 slash+융합이동). 클라이언트(엔진·castSlash)는 main push로 GitHub Pages 자동 배포.
