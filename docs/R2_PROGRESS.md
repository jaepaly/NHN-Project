...
**의존성·현재 상태**
- [x] 최신 `main` `6a41a94`에서 `codex/direct-room-select-transition` 브랜치 생성.
...
- [x] 5-4 자동 검증: 전체 지도·선택 제한·설명·키보드 회귀와 맵/보상 배선 회귀를 보강하고, 전체 회귀 78종·프로덕션 빌드·`git diff --check` 통과.
