...
**③ 본작업 B — 바닥형 지형** ([#237](https://github.com/jaepaly/NHN-Project/pull/237) — config+씬배선 5스텝, **리뷰 대기**)
- [x] 용암 — 해저드 리스킨(주황·fire, 초당 12·잔류 없음)
- [x] 독지대 — 피해 낮게(초당 4·dark) + 이탈 후 2초 도트 잔류 + 약화·둔화 디버프
- [x] 씬 배선 5스텝(terrainBarrier #236 미러): ①렌더 ②틱피해 ③플레이어 디버프 ④잔류도트 ⑤카운터 정화(상성 시전으로 씻기+지형 면역). #239 조율대로 R2 몫.
