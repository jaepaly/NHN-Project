...
> ✅ **후속 해소 (2026-07-26, v2.14)**: 아래에서 지적한 **근접 참격(화염검 등)이 `bolt`로 뭉개지던 문제**는 `slash` form 신설(#188·#189→#191 DSL + 총괄 castSlash #190/192/193)로 해결됨. 실측: 근접 100% slash, 비근접 잠식 0. 아래는 그 이전 시점(v2.5 이전)의 감사 기록.
>
