...
| 2026-07-14 | 이도원 | Codex | beam·wave 주문 폼 및 전투 마무리 | 직선 관통 광선과 전진형 파면의 다중 적 1회 피해를 구현하고, 1분 내 웨이브 검증용 적 HP·기본 공격 수치와 긴 주문명 표시를 함께 정리 | `feat/spell-renderer-forms`, 렌더러·적중 판정·전투 설정·주문명 검증/UI | `SpellSpec` 구조 유지, 폼 수치·적 HP는 임시값 |
